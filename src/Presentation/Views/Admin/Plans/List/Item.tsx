...
export const AdminPlansListItem = ({category, remove}: Props) => {
    const navigation = useNavigation<StackNavigationProp<PlansStackParamList>>();
        ...
        >
            <View style={ styles.container }>
                ...
                <View style={ styles.actionContainer }>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('AdminPlansUpdateScreen', {category: category})}
                    >
                        <Image 
